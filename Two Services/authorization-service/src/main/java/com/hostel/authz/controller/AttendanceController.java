...
public class AttendanceController {
    ...
    public ResponseEntity<ApiResponse<List<AttendanceDto>>> getAttendanceByStudent(@PathVariable("studentId") Long studentId) {
        return ResponseEntity.ok(ApiResponse.success("Student attendance retrieved", hostelService.getAttendanceByStudent(studentId)));
    }
    ...
    public ResponseEntity<ApiResponse<List<AttendanceDto>>> getAttendanceByMonth(
            @PathVariable("studentId") Long studentId, @RequestParam("year") int year, @RequestParam("month") int month) {
        return ResponseEntity.ok(ApiResponse.success("Monthly attendance retrieved", hostelService.getAttendanceByMonth(studentId, year, month)));
    }
